...
import com.sazzad.event_ticket.domain.dtos.GetTicketResponseDto;
import com.sazzad.event_ticket.domain.dtos.ListTicketResponseDto;
import com.sazzad.event_ticket.domain.dtos.ListTicketTicketTypeResponseDto;
...
public interface TicketMapper {
    ...
    @Mapping(target = "eventName", source = "ticket.ticketType.event.event.venue")
